...
path = 'E:\Git_Clone/VUE_R6_FTL/@CONTROL/视图布局面板/'
file = './uid_1150aed716a19ceb0a37cf9.xls'

path2 = 'E:\Git_Clone/VUE_R6_FTL/@CONTROL/视图布局面板/'
...
def properViews():
    ...
    while row_index < sheet1.nrows:
        ...
        print(hastype, '==========',viewname, '==========', viewid, '==========', isentityview)
